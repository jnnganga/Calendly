...
const Body = () => {
	...
	return (
		<div className='max-w-[1240px] m-auto min-h-screen  '>
			...
			<div style={{ display: `${isActive === 3 ? "block" : "none"}` }}>
				<Tabsection data={recruitingData} hero={"recruiting_hero.png"} />
			</div>

			<div style={{ display: `${isActive === 4 ? "block" : "none"}` }}>
				<Tabsection data={technologyData} hero={"technology_hero.png"} />
			</div>
		</div>
	);
};
