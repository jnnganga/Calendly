...
const ProductDialog = () => {
	return (
		<div className='z-10 grid grid-cols-4 mt-5 mx-16 w-128  rounded-lg shadow-lg bg-white'>
			...
			<div className='col-span-3'>
				...
				<div className='grid grid-cols-3 m-5 '>
					...
					<div>
						<h1 className=' font-bold mb-5 hover:text-blue-500 hover:cursor-pointer'>
							Sales
						</h1>
						<h1 className=' font-bold mb-5 hover:text-blue-500 hover:cursor-pointer'>
							Recruiting
						...
						<h1 className=' font-bold mb-10 hover:text-blue-500 hover:cursor-pointer'>
							Marketing
						</h1>
						<h1 className=' font-bold hover:text-blue-500 hover:cursor-pointer'>
							Integrations
						</h1>
